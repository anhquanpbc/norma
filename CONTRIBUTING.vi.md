...
Mọi thứ còn lại — `standard/rules.json`, `AGENTS.md`, `CLAUDE.md`, `.cursor/rules/*`,
`.github/copilot-instructions.md`, `.github/instructions/*` — đều **được sinh tự động**. Sau khi sửa một
nguồn, chạy:
...
động (`AGENTS.md`, `CLAUDE.md`, `.cursor/rules/*`, `.github/copilot-instructions.md`,
`.github/instructions/*`) **chỉ tiếng Anh**, vì công cụ AI dùng chúng bằng tiếng Anh.
...
- Điền checklist trong template PR (đã regenerate? lint:self xanh?).
