...
- **Social / link previews.** The core Open Graph set — `og:title`, `og:type`, `og:image` (~1200×630), `og:url` — plus `twitter:card`. Without them, shared links render as a bare URL (`seo.og-tags`).
